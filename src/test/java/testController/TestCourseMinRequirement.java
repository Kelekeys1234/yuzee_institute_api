	...
	void saveMinRequirement() {
		try {
			...
			ResponseEntity<String> response = testRestTemplate.exchange(
					api + PATH_SEPARATOR + courseId + PATH_SEPARATOR + "min-requirement", HttpMethod.POST, entity,
					String.class);
			...
			ResponseEntity<String> response = testRestTemplate.exchange(api + PATH_SEPARATOR + courseId + PATH_SEPARATOR
					+ "min-requirement?course_min_requirement_ids=" + "1e348e15-45b6-477f-a457-883738227e01",
	...
	void updateMinRequirement() {
		...
		try {
			...
			ResponseEntity<String> responsed = testRestTemplate.exchange(
					api + PATH_SEPARATOR + courseId + PATH_SEPARATOR + "min-requirement", HttpMethod.POST, entityy,
					String.class);
			...
			ResponseEntity<String> responsee = testRestTemplate.exchange(
					api + PATH_SEPARATOR + courseId + PATH_SEPARATOR
							+ "min-requirement?course_min_requirement_ids=1e348e15-45b6-477f-a457-883738227e05",
	...
	void getCourseMinRequirement() {
		...
		try {
			...
			ResponseEntity<String> responses = testRestTemplate.exchange(
					api + PATH_SEPARATOR + courseId + PATH_SEPARATOR + "min-requirement", HttpMethod.GET, entityy,
					String.class);
			...
			ResponseEntity<String> responses = testRestTemplate.exchange(
					api + PATH_SEPARATOR + courseId + PATH_SEPARATOR
							+ "min-requirement?course_min_requirement_ids=1e348e15-45b6-477f-a457-883738227e08",
