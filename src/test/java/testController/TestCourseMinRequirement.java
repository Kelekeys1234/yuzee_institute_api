...
//	linkedCourseId.add("527cf280-9206-461e-ad2a-49b00d9d5be2");
...
//			api +PATH_SEPARATOR+"527cf280-9206-461e-ad2a-49b00d9d5be2"
...
//	language.add("English");
//	List<String>linkedCourseId = new ArrayList<>();
//	linkedCourseId.add("96a2e11b-d64b-4964-9d28-2a4d7a41d944");
//	CourseMinRequirementDto minRequirementDto = new CourseMinRequirementDto();
