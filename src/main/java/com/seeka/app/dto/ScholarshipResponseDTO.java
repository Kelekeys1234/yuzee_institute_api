...
public class ScholarshipResponseDTO implements Serializable {
	...
	public String toString() {
		...
		builder.append("ScholarshipResponseDTO [id=").append(id).append(", name=").append(name)
				.append(", offeredByInstitute=").append(offeredByInstitute).append(", offeredByCourse=")
				.append(offeredByCourse).append(", description=").append(description).append(", scholarshipAward=")
				.append(scholarshipAward).append(", countryId=").append(countryId).append(", levelId=").append(levelId)
				.append(", numberOfAvaliability=").append(numberOfAvaliability).append(", scholarshipAmount=")
				.append(scholarshipAmount).append(", validity=").append(validity).append(", howToApply=")
				.append(howToApply).append(", gender=").append(gender).append(", eligibleNationality=")
				.append(eligibleNationality).append(", headquaters=").append(headquaters).append(", email=")
				.append(email).append(", address=").append(address).append(", createdOn=").append(createdOn)
				.append(", updatedOn=").append(updatedOn).append(", createdBy=").append(createdBy)
				.append(", updatedBy=").append(updatedBy).append(", deletedOn=").append(deletedOn).append(", isActive=")
				.append(isActive).append(", website=").append(website).append(", instituteId=").append(instituteId)
				.append(", applicationDeadline=").append(applicationDeadline).append(", intakes=").append(intakes)
				.append(", languages=").append(languages).append(", countryName=").append(countryName)
				.append(", levelName=").append(levelName).append(", currency=").append(currency)
				.append(", instituteName=").append(instituteName).append(", requirements=").append(requirements)
				.append("]");
