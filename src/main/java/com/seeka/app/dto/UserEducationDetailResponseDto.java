...
public class UserEducationDetailResponseDto implements Serializable {
	...
	public String toString() {
		...
		builder.append("UserEducationDetailResponseDto [educationCountryId=").append(educationCountryId).append(", educationSystemId=")
				.append(educationSystemId).append(", educationLevelId=").append(educationLevelId).append(", educationInstitue=").append(educationInstitue)
				.append(", gpaScore=").append(gpaScore).append(", isEnglishMedium=").append(isEnglishMedium).append(", englishLevel=").append(englishLevel)
				.append(", eduSysScore=").append(eduSysScore).append(", fromDuration=").append(fromDuration).append(", toDuration=").append(toDuration)
				.append(", eduLevel=").append(eduLevel).append(", educationSystemName=").append(educationSystemName).append(", educationCountryName=")
				.append(educationCountryName).append(", educationQualification=").append(educationQualification).append("]");
