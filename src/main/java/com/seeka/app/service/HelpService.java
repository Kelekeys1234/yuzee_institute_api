...
public class HelpService implements IHelpService {
	...
	public SeekaHelp convertDtoToSeekaHelp(HelpDto dto, BigInteger id) {
		...
		seekaHelp.setSubCategory(helpDAO.getHelpSubCategory(dto
				.getSubCategoryId()));
	...
	public HelpCategory convertHelpCategoryDtoToBean(
	...
	public HelpSubCategory convertHelpCategoryDtoToBean(
			HelpSubCategoryDto helpSubCategoryDto) {
		...
		helpSubCategory.setCategoryId(helpDAO
				.getHelpCategory(helpSubCategoryDto.getCategoryId()));
	...
	public HelpSubCategoryDto convertHelpSubCategoryToDto(
			HelpSubCategory helpSubCategory) {
		HelpSubCategoryDto helpSubCategoryDto = new HelpSubCategoryDto();
		helpSubCategoryDto.setCategoryId(helpSubCategory.getCategoryId()
				.getId());
	...
	public Map<String, Object> getSubCategoryByCategory(BigInteger categoryId) {
		...
		try {
			List<HelpSubCategory> categories = helpDAO
					.getSubCategoryByCategory(categoryId);
			for (HelpSubCategory helpSubCategory : categories) {
				subCategoryDtos
						.add(convertHelpSubCategoryToDto(helpSubCategory));
			}
	...
	public Map<String, Object> getSubCategoryCount() {
		...
		try {
			List<HelpSubCategory> subCatgories = helpDAO
					.getAllHelpSubCategories();
			for (HelpSubCategory helpSubCategory : subCatgories) {
				helpSubCategory.setCount(helpDAO
						.findTotalHelpRecordBySubCategory(helpSubCategory
								.getId()));
