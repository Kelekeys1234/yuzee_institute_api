...
public class ArticleService implements IArticleService {
    ...
    @Override
    public Map<String, Object> fetchAllArticleByPage(final BigInteger page, final BigInteger size, final String query, final boolean status, final BigInteger categoryId,
                    final String tag, final String status2) {
        Map<String, Object> response = new HashMap<>();
    ...
    private ElasticSearchArticleDto getElasticSearchDto(SeekaArticles articleData) {
