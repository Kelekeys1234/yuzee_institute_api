...
public class ElasticSearchService {
    ...
    public void saveCourseOnElasticSearch(String elasticSearchIndex, String type, List<CourseDTOElasticSearch> courseList, String elasticSearchName) {
    ...
    public Map<String, List<BigInteger>> updateCourseOnElasticSearch(String elasticSearchIndex, String type, List<CourseDTOElasticSearch> courseList, String elasticSearchName) {
    	...
    	for (CourseDTOElasticSearch courseElasticSearch : courseList) {
            ...
            HttpHeaders headers = new HttpHeaders();
            HttpEntity<ElasticSearchDTO> httpEntity = new HttpEntity<>(elasticSearchDto, headers);
            ResponseEntity<Map> result = restTemplate.exchange("http://" + IConstant.ELASTIC_SEARCH_URL,HttpMethod.PUT, httpEntity, Map.class, new Object[] {});
    ...
    public void updateArticleOnElasticSearch(String elasticSearchIndex, String type, final ArticleElasticSearchDto articleDto, String elasticSearchName) {
            ElasticSearchDTO elasticSearchDto = new ElasticSearchDTO();
            elasticSearchDto.setIndex(elasticSearchIndex);
            elasticSearchDto.setType(type);
            elasticSearchDto.setEntityId(String.valueOf(articleDto.getId()));
