...
public class CourseDAO implements ICourseDAO {
    ...
    private String getInstituteImage(final String instituteId, final Session session) {
        String logo = null;
    ...
    private String getInstituteLogo(final String instituteId, final Session session) {
        String logo = null;
    ...
    @Override
    public List<UserCompareCourse> getUserCompareCourse(BigInteger userId) {
        List<UserCompareCourse> compareCourses = new ArrayList<UserCompareCourse>();
        Session session = sessionFactory.getCurrentSession();
