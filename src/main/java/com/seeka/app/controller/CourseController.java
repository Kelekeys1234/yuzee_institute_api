...
public class CourseController {
	...
	public ResponseEntity<?> update(@Valid @RequestBody final CourseRequest course, @PathVariable final BigInteger id)
			throws Exception {
	...
	private ResponseEntity<?> courseSearch(final CourseSearchDto courseSearchDto) {
		...
		for (CourseResponseDto obj : courseList) {
			try {
				...
				obj.setInstituteLogoUrl(
						CDNServerUtil.getInstituteLogoImage(obj.getCountryName(), obj.getInstituteName()));
				obj.setInstituteImageUrl(
						CDNServerUtil.getInstituteMainImage(obj.getCountryName(), obj.getInstituteName()));
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
	...
	public ResponseEntity<?> getAllMyCourses(@RequestBody final CourseSearchDto courseSearchDto) throws Exception {
		...
		if (null != courseSearchDto.getCurrencyId()
			...
			message = "Do you want to change " + currency.getName() + " (" + currency.getCode()
					+ ") as your currency.?";
		} else {
	...
	public ResponseEntity<?> get(@Valid @PathVariable final BigInteger id) throws Exception {
		...
		if (instituteObj != null && instituteObj.getCountry() != null) {
			courseRequest.setInstituteLogoUrl(
					CDNServerUtil.getInstituteLogoImage(instituteObj.getCountry().getName(), instituteObj.getName()));
			courseRequest.setInstituteImageUrl(
					CDNServerUtil.getInstituteMainImage(instituteObj.getCountry().getName(), instituteObj.getName()));
		}
	...
	public ResponseEntity<?> getAllCourseByInstituteID(@Valid @PathVariable final BigInteger instituteId,
		...
		instituteResponseDto.setInstituteLogoUrl(CDNServerUtil
				.getInstituteLogoImage(instituteResponseDto.getCountryName(), instituteResponseDto.getInstituteName()));
		instituteResponseDto.setInstituteImageUrl(CDNServerUtil
				.getInstituteMainImage(instituteResponseDto.getCountryName(), instituteResponseDto.getInstituteName()));
