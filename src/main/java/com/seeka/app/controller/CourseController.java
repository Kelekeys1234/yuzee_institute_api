...
public class CourseController {
    ...
    public ResponseEntity<?> searchCourse(@RequestHeader(required = true) BigInteger userId , @RequestBody final CourseSearchDto courseSearchDto) throws Exception {
        courseSearchDto.setUserId(userId);
        return courseSearch(courseSearchDto);
    }
    ...
    public ResponseEntity<?> advanceSearch(@RequestHeader(required = true) BigInteger userId, @RequestBody final AdvanceSearchDto courseSearchDto) throws Exception {
        courseSearchDto.setUserId(userId);
