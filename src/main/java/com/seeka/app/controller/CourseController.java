...
public class CourseController {
    ...
    public ResponseEntity<?> searchCourse(@RequestParam(required = false) final BigInteger countryId, @RequestParam(required = false) final BigInteger instituteId,
                    @RequestParam(required = false) final BigInteger facultyId, @RequestParam(required = false) final String name,
                    @RequestParam(required = false) final String languauge) throws Exception {
    ...
    public ResponseEntity<?> getAllCourseByInstituteID(@Valid @PathVariable final BigInteger instituteId, @Valid @RequestBody final CourseSearchDto request) throws Exception {
        ErrorDto errorDto = null;
        Map<String, Object> response = new HashMap<>();
    ...
    public ResponseEntity<?> userCompareCourse(@Valid @RequestBody UserCourse userCourse) throws Exception {
    ...
    public ResponseEntity<?> getUserCompareCourse(@PathVariable BigInteger userId) throws Exception {
