...
public class MigrateInstituteController {
    ...
    public Map<String, Institute> get() throws Exception {
        ...
        List<Service> serviceDetailList = serviceDetailsService.getAll();
        Map<String, Service> serviceMap = new HashMap<String, Service>();

        for (Service serviceObj : serviceDetailList) {
        ...
        while (rowIterator.hasNext()) {
            ...
            instituteDetails.setAvgCostOfLiving(avg_cost_of_living);
            ...
            instituteDetails.setTtionFeesPPlan(Ttion_fees_p_plan);
    ...
    public InstituteService getInsService(Map<String, Service> serviceMap, String serviceName, String field) {
        try {
