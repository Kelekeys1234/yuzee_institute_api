...
public class MigrateCourseControllerTesting {
    ...
    public static void main(String[] args) throws Exception {
        String myFile = "E:\\Softwares\\Seeka\\March-2019\\Course\\course\\university_course_attribute_uas.xlsx";

        /*
         * InputStream is = new FileInputStream(new File("/path/to/workbook.xlsx")); StreamingReader reader = StreamingReader.builder() .rowCacheSize(100) // number of rows to keep
         * in memory (defaults to 10) .bufferSize(4096) // buffer size to use when reading InputStream to file (defaults to 1024) .sheetIndex(0) // index of sheet to use (defaults
         * to 0) .read(is);
         */

        SXSSFWorkbook wb = new SXSSFWorkbook(new XSSFWorkbook(new FileInputStream(myFile)));
        ...
        while (rowIterator.hasNext()) {
            ...
            String Cost_Savings = "", Cost_Range = "", Remarks_ = "", Twinning_Program = "", UK_A_LEV_1 = "", UK_A_LEV_2 = "", UK_A_LEV_3 = "", UK_A_LEV_4 = "", UK_A_LEV_5 = "",
                            ...
                            SGP_A_LEVE_1 = "", SGP_A_LEVE_2 = "", SGP_A_LEVE_3 = "", SGP_A_LEVE_4 = "", SGP_A_LEVE_5 = "", SGP_O_LEV1 = "", US_GPA = "", GLOB_IB = "",
                            THA_MathayomSuksa_5_6 = "", PHILIP_HSC = "", NEP_HSC = "", PAK_HSC = "", INDO_SMU = "", JAPAN_KSS = "", SRI_A_LEV_1 = "", SRI_A_LEV_2 = "",
                            SRI_A_LEV_3 = "", SRI_A_LEV_4 = "", SRI_A_LEV_5 = "", SRI_O_LEV1 = "", GLOB_GPA = "", BAN_HSC = "", IRAN_DM_HSC = "", KSA_DM_HSC = "",
