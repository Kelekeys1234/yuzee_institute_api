...
public class InstituteController {
    ...
    public ResponseEntity<?> save(@Valid @RequestBody InstituteRequestDto institute) throws Exception {
        return ResponseEntity.accepted().body(instituteService.save(institute));
    }

    @RequestMapping(value = "/{id}", method = RequestMethod.POST, consumes = "application/json", produces = "application/json")
    public ResponseEntity<?> update(@Valid @PathVariable BigInteger id, @RequestBody InstituteRequestDto institute) throws Exception {
    ...
    public ResponseEntity<?> searchInstitute(@Valid @PathVariable String searchText) throws Exception {
