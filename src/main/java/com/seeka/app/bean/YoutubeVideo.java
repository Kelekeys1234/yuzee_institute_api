...
public class YoutubeVideo implements java.io.Serializable {
	...
	public String toString() {
		return "YoutubeVideo [youtubeVideoId=" + youtubeVideoId + ", id=" + id + ", type=" + type + ", videoTitle="
				+ videoTitle + ", description=" + description + ", vedioId=" + vedioId + ", url=" + url + ", createdOn="
				+ createdOn + ", updatedOn=" + updatedOn + ", createdBy=" + createdBy + ", updatedBy=" + updatedBy
				+ ", name=" + name + ", uploadDate=" + uploadDate + "]";
	}
}