...
public class Hobbies implements Serializable {
	...
	public Hobbies(String hobbyTxt, Date createdOn, Date updatedOn, Date deletedOn, String createdBy, String updatedBy,
			Boolean isDeleted) {
	...
	public String toString() {
		...
		builder.append("Hobbies [id=").append(id).append(", hobbyTxt=").append(hobbyTxt).append(", createdOn=")
