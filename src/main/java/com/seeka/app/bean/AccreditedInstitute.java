...
public class AccreditedInstitute implements Serializable {
	...
	public String toString() {
		...
		builder.append("AccreditedInstitute [id=").append(id).append(", name=").append(name).append(", logoImage=").append(logoImage).append(", description=")
				.append(description).append(", isActive=").append(isActive).append(", createdOn=").append(createdOn).append(", updatedOn=").append(updatedOn)
				.append(", deletedOn=").append(deletedOn).append(", createdBy=").append(createdBy).append(", updatedBy=").append(updatedBy)
				.append(", deletedBy=").append(deletedBy).append(", logoUrl=").append(logoUrl).append("]");
