...
public class Country implements Serializable {
	...
	public Country(String name, String description, String countryCode, Date createdOn, Date updatedOn, Date deletedOn,
	...
	public String toString() {
		...
		builder.append("Country [id=").append(id).append(", name=").append(name).append(", description=")
				.append(description).append(", countryCode=").append(countryCode).append(", createdOn=")
