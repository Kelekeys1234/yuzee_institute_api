...
import com.yuzee.app.dao.EducationAgentDao;
import com.yuzee.app.dto.EducationAgentGetAllDto;

@Component
@SuppressWarnings({ "rawtypes", "unchecked", "deprecation" })
public class EducationAgentDaoImpl implements EducationAgentDao {
    ...
    public void deleteEducationAgentSkill(String educationAgentId) {
        Session session = sessionFactory.getCurrentSession();
        Query query = session.createSQLQuery("DELETE FROM education_agent_skill WHERE education_agent_id ='" + educationAgentId + "'");
        query.executeUpdate();
    }
    ...
    public void deleteAgentServiceOffered(String educationAgentId) {
        Session session = sessionFactory.getCurrentSession();
        Query query = session.createSQLQuery("DELETE FROM agent_service_offered WHERE education_agent_id ='" + educationAgentId + "'");
        query.executeUpdate();
    }
    ...
    public void deleteAgentEducationDetail(String educationAgentId) {
        Session session = sessionFactory.getCurrentSession();
        Query query = session.createSQLQuery("DELETE FROM agent_education_detail WHERE education_agent_id ='" + educationAgentId + "'");
        query.executeUpdate();
    }
    ...
    public void deleteAgentMediaDocumentation(String educationAgentId) {
        Session session = sessionFactory.getCurrentSession();
        Query query = session.createSQLQuery("DELETE FROM agent_media_documentation WHERE education_agent_id ='" + educationAgentId + "'");
        query.executeUpdate();
    }
    ...
    public List<AgentServiceOffered> fetchAgentServiceOffered(String educationAgent) {
        ...
        List<Object[]> agentService = session
                        .createSQLQuery("SELECT aso.amount, aso.service_id, aso.currency FROM agent_service_offered as aso WHERE education_agent_id ='" + educationAgent + "'").list();
    ...
    public void deleteEducationAgentPartnerships(String educationAgentId) {
        Session session = sessionFactory.getCurrentSession();
        Query query = session.createSQLQuery("DELETE FROM education_agent_partnerships WHERE education_agent_id ='" + educationAgentId + "'");
        query.executeUpdate();
    ...
    public void deleteEducationAgentAccomplishment(String educationAgent) {
        Session session = sessionFactory.getCurrentSession();
        Query query = session.createSQLQuery("DELETE FROM education_agent_accomplishment WHERE education_agent_id ='" + educationAgent + "'");
        query.executeUpdate();
    }
