...
public class InstituteController implements InstituteInterface {
	...
	public ResponseEntity<?> getInstituteTypeByCountry(String countryName) throws Exception {
		...
		return new GenericResponseHandlers.Builder().setData(listOfInstituteTypes)
				.setMessage(messageTranslator.toLocale("institute.type.list.retrieved")).setStatus(HttpStatus.OK)
				.create();
	}
	...
	@Override
	public ResponseEntity<?> instituteSearch(final Integer pageNumber, final Integer pageSize,
			final List<String> countryNames, final List<String> facultyIds, final List<String> levelIds,
			final String cityName, final String instituteType, final Boolean isActive, final Date updatedOn,
			final Integer fromWorldRanking, final Integer toWorldRanking, final String sortByField,
			final String sortByType, final String searchKeyword, final Double latitutde, final Double longitude)
		...
		return getInstitutesBySearchFilters(courseSearchDto, sortByField, sortByType, searchKeyword, cityName,
				instituteType, isActive, updatedOn, fromWorldRanking, toWorldRanking);
	}

	private ResponseEntity<?> getInstitutesBySearchFilters(final CourseSearchDto request, final String sortByField,
			final String sortByType, final String searchKeyword, final String cityId, final String instituteTypeId,
		...
		List<InstituteResponseDto> instituteList = instituteProcessor.getAllInstitutesByFilter(request, sortByField,
				sortByType, searchKeyword, startIndex.intValue(), cityId, instituteTypeId, isActive, updatedOn,
			...
			instituteList.forEach(instituteResponseDto -> {
				try {
					...
					List<StorageDto> storageDTOList = storageHandler.getStorages(
							instituteResponseDto.getId().toString(), EntityTypeEnum.INSTITUTE,
		...
		int totalCount = instituteProcessor.getCountOfInstitute(request, searchKeyword, cityId, instituteTypeId, true,
				updatedOn, fromWorldRanking, toWorldRanking);
		log.info(
				"Calling pagination class to calculate pagination based on startIndex, pageSixe and totalCount of institutes");
		PaginationUtilDto paginationUtilDto = PaginationUtil.calculatePagination(startIndex,
				request.getMaxSizePerPage(), totalCount);
	...
	public ResponseEntity<?> getAllRecommendedInstitutes(final CourseSearchDto request) throws Exception {
		...
		List<InstituteResponseDto> instituteResponseDtoList = instituteProcessor.getAllInstitutesByFilter(request, null,
				null, null, startIndex.intValue(), null, null, null, null, null, null);
		...
		return new GenericResponseHandlers.Builder().setData(paginationDto)
				.setMessage(messageTranslator.toLocale("institute.list.retrieved")).setStatus(HttpStatus.OK).create();
	}
	...
	public ResponseEntity<?> getInstituteByCityName(final String cityName) throws Exception {
		...
		return new GenericResponseHandlers.Builder().setData(institutes)
				.setMessage(messageTranslator.toLocale("institute.list.retrieved")).setStatus(HttpStatus.OK).create();
	}
	...
	@Override
	public ResponseEntity<?> update(final String userId, final String instituteId, final InstituteRequestDto institute)
			throws Exception {
	...
	@Override
	public ResponseEntity<?> getAllInstitute(final String searchKey, final Integer pageNumber, final Integer pageSize)
			throws Exception {
	...
	public ResponseEntity<?> searchInstitute(final String searchText) throws Exception {
		...
		return new GenericResponseHandlers.Builder().setData(instituteGetRequestDtos)
				.setMessage(messageTranslator.toLocale("institute.list.retrieved")).setStatus(HttpStatus.OK).create();
	}
	...
	public ResponseEntity<?> getAllCategoryType() throws Exception {
		...
		return new GenericResponseHandlers.Builder().setData(categoryTypes)
				.setMessage(messageTranslator.toLocale("institute.category-type.list.retrieved"))
				.setStatus(HttpStatus.OK).create();
	}
	...
	public ResponseEntity<?> delete(final String instituteId) throws ValidationException {
		...
		return new GenericResponseHandlers.Builder().setMessage(messageTranslator.toLocale("institute.deleted"))
				.setStatus(HttpStatus.OK).create();
	}
	...
	public ResponseEntity<?> getInstituteImage(final String instituteId) throws Exception {
		...
		List<StorageDto> storageDTOList = storageHandler.getStorages(instituteId, EntityTypeEnum.INSTITUTE,
				EntitySubTypeEnum.IMAGES);
		return new GenericResponseHandlers.Builder().setData(storageDTOList)
				.setMessage(messageTranslator.toLocale("institute.image.list.retrieved")).setStatus(HttpStatus.OK)
				.create();
	}
	...
	public ResponseEntity<?> getTotalCourseForInstitute(final String instituteId) throws ValidationException {
		...
		return new GenericResponseHandlers.Builder().setData(courseCount)
				.setMessage(messageTranslator.toLocale("institute.course.count.retrieved")).setStatus(HttpStatus.OK)
				.create();
	}
	...
	public ResponseEntity<?> getHistoryOfDomesticRanking(final String instituteId) throws ValidationException {
		...
		List<InstituteDomesticRankingHistoryDto> instituteDomesticRankingHistory = instituteProcessor
				.getHistoryOfDomesticRanking(instituteId);
		return new GenericResponseHandlers.Builder().setData(instituteDomesticRankingHistory)
				.setMessage(messageTranslator.toLocale("institute.domestic-ranking.history.list.retrieved"))
				.setStatus(HttpStatus.OK).create();
	}
	...
	public ResponseEntity<?> getHistoryOfWorldRanking(final String instituteId) throws ValidationException {
		...
		List<InstituteWorldRankingHistoryDto> instituteWorldRankingHistory = instituteProcessor
				.getHistoryOfWorldRanking(instituteId);
		return new GenericResponseHandlers.Builder().setData(instituteWorldRankingHistory)
				.setMessage(messageTranslator.toLocale("institute.world-ranking.history.list.retrieved"))
				.setStatus(HttpStatus.OK).create();
	}
	...
	public ResponseEntity<?> getDomesticRanking(final List<String> courseIds) throws ValidationException {
		...
		return new GenericResponseHandlers.Builder().setData(instituteIdDomesticRanking)
				.setMessage(messageTranslator.toLocale("domestic-ranking.list.retrieved")).setStatus(HttpStatus.OK)
				.create();
	}
	...
	public ResponseEntity<?> getNearestInstituteList(final AdvanceSearchDto courseSearchDto) throws Exception {
		...
		return new GenericResponseHandlers.Builder().setData(nearestInstituteDTOs)
				.setMessage(messageTranslator.toLocale("institute.list.retrieved")).setStatus(HttpStatus.OK).create();
	}

	@Override
	public ResponseEntity<?> getDistinctInstitutes(final Integer pageNumber, final Integer pageSize, final String name)
			throws Exception {
		...
		List<InstituteResponseDto> instituteList = instituteProcessor.getDistinctInstituteList(startIndex.intValue(),
				pageSize, name);
	...
	public ResponseEntity<?> getBoundedInstituteList(final Integer pageNumber, final Integer pageSize,
		...
		Long startIndex = PaginationUtil.getStartIndex(pageNumber, pageSize);
		NearestInstituteDTO nearestInstituteList = instituteProcessor
				.getInstitutesUnderBoundRegion(startIndex.intValue(), pageSize, latLongDto);
	...
	public ResponseEntity<?> getInstituteByCountryName(Integer pageNumber, Integer pageSize, String countryName)
			throws NotFoundException {
		NearestInstituteDTO instituteResponse = instituteProcessor.getInstituteByCountryName(countryName, pageNumber,
				pageSize);
	...
	public ResponseEntity<?> getInstituteFaculties(String instituteId) throws NotFoundException {
		...
		return new GenericResponseHandlers.Builder().setData(instituteFaculties)
				.setMessage(messageTranslator.toLocale("institute.faculty.list.retrieved")).setStatus(HttpStatus.OK)
				.create();
	}
	...
	@Override
	public ResponseEntity<?> getInstitutesByIdList(List<String> instituteIds)
			throws NotFoundException, InvokeException, Exception {
		...
		return new GenericResponseHandlers.Builder().setData(instituteList)
				.setMessage(messageTranslator.toLocale("institute.list.retrieved")).setStatus(HttpStatus.OK).create();
	}
	...
	public ResponseEntity<?> getInstituteVerificationStatus(String instituteId) {
		...
		return new GenericResponseHandlers.Builder()
				...
				.setMessage(messageTranslator.toLocale("institute.verification.info.retrieved"))
				.setStatus(HttpStatus.OK).create();
	}
	...
	public ResponseEntity<Object> verifyInstitutes(String userId, List<String> verifiedInstituteIds, boolean verified) {
		log.info(
				"Class InstituteController method verifyInstitutes userId : {}, verifiedInstitutes : {}, verified : {}",
		...
		return new GenericResponseHandlers.Builder().setStatus(HttpStatus.OK)
				.setMessage("Institutes verified successfully.").create();
